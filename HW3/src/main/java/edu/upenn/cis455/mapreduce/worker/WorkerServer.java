...
public class WorkerServer {
    ...
    static Map<String, String> serverConfig;
    ...
    public WorkerServer(int myPort) throws MalformedURLException {
        ...
        Spark.post("/definejob", new Route() {
                ...
                public Object handle(Request arg0, Response arg1) {
                    ...
                    try {
                        ...
                        WorkerAccountant.setJob( workerJob.getConfig().get("job"));
                        workerJob.getConfig().put("storageDir", serverConfig.get("storageDir"));
        ...
        // Handles /shutdown to shut down the worker

        Spark.post("/shutdown", new Route() {
                @Override
                public Object handle(Request arg0, Response arg1) {
                    log.info(String.format("Worker running at %d has shutdown.", myPort));
					WorkerServer.shutdown();  
					System.out.println("The worker will shutdown shortly");
					return "Worker successfully shut down";                                
                }    
            });
    ...
    public static void shutdown() {
        ...
        cluster.shutdown();
        WorkerAccountant.setShutdownFlag(true);
    }
}
